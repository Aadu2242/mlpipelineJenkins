...
with open('ml/templates/titanic_miner_template.json') as data_file:
    arguments = json.load(data_file)

df_train = pd.read_csv('ml/data/titanic_train.csv',encoding="latin-1")
...
df_train = pd.read_csv('ml/data/titanic_test.csv',encoding="latin-1")
